...
The repository intentionally begins with no physical-device claims. iOS/Android Wi-Fi Aware, BLE and background behavior remain unchecked in `docs/TODO.md` (Priority 3) until real signed-off records exist.
