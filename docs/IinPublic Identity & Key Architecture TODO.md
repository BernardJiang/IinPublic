...
- [ ] Later replace the browser v1 password-removal target with a reviewed password-free v3 using
      ...
      Browser rollout completed 2026-09-18: the v3 envelope, non-extractable IndexedDB key store,
      CAS guards, transactional copy/verify/delete coordinator, production startup/password-removal
      wiring, erase/reset integration, safe v1 fallback, and real Chromium/WebKit/Firefox
      process-restart proof are implemented and documented in
      `docs/security/password-free-identity-custody-v3.md`. Native providers, physical native
      validation, and external review remain open.
