 ...
 *
 * Renamed 15- → 00-: at ~122s this is one of the slowest light-shard specs; the 00- prefix
 * makes Playwright schedule it first so it never sets the shard tail (see playwright.config.ts).
 */
