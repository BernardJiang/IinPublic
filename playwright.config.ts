  ...
  return [
    {
      ...
      command: process.platform === 'win32'
        ? `node scripts/e2e-gun-server.mjs ${gunPort} ${E2E_P2P_NODE_ENABLED}`
        : `CHATROOM_MAX_CAPACITY=50 CHATROOM_ENABLE_FIFO=false E2E_GUN_MEMORY_ONLY=1 P2P_NODE_ENABLED=${E2E_P2P_NODE_ENABLED} P2P_RATE_LIMIT_MAX_EVENTS=5000 IINPUBLIC_DOWNLOADS_DIR=__e2e_no_downloads__ NODE_OPTIONS=--max-old-space-size=8192 PORT=${gunPort} node dist/server/server/index.js`,
      port: gunPort,
      timeout: 120 * 1000,
