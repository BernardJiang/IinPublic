...
exports.getLocationChatroomPath = getLocationChatroomPath;
exports.getParentChatroom = getParentChatroom;
exports.findAppropriateChildChatroom = findAppropriateChildChatroom;
const chatroom_hierarchy_1 = require("./chatroom-hierarchy");
/**
 ...
 */
function getLocationChatroomPath(location) {
 ...
 */
function getParentChatroom(chatroomId) {
    ...
    traverse(chatroom_hierarchy_1.CHATROOM_HIERARCHY, null);
    return parent;
}
/**
 ...
 */
function findAppropriateChildChatroom(currentChatroomId, userLocation) {
...
//# sourceMappingURL=location-to-chatroom.js.map