...
exports.LocationFilter = exports.ChatroomLocationManager = exports.LocationPrivacy = void 0;
/**
...
class LocationPrivacy {
     ...
     */
    static blurLocation(coordinate) {
     ...
     */
    static generateChatroomId(region, userCount) {
     ...
     */
    static isInRegion(coordinate, region) {
     ...
     */
    static getNearbyRegions(region, radius = 1) {
        ...
        const regions = [region]; // Include current region
...
exports.LocationPrivacy = LocationPrivacy;
class ChatroomLocationManager {
    /**
     * Determine appropriate chatroom for a user based on location and capacity
     */
    static async findOptimalChatroom(location, _maxUsersPerRoom = 50) {
     ...
     */
    static async handleRoomSplit(chatroomId, currentUsers) {
        const maxUsersPerRoom = 50;
     ...
     */
    static async handleRoomMerge(region, _minUsersPerRoom = 10) {
...
exports.ChatroomLocationManager = ChatroomLocationManager;
/**
...
class LocationFilter {
     ...
     */
    static filterByProximity(users, targetLocation, _maxDistance = 5000 // 5km default
    ) {
     ...
     */
    static getLocationBasedPrompts(_location) {
